...
try:
    prox= requests.get('https://github.com/Rimu-404/SAGOR').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/Rimu-404/SAGOR').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd=requests.get('https://github.com/Rimu-404/SAGOR').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
os.system('https://chat.whatsapp.com/DwYfY60xrnm3lH6pLloZWT')
def ua_api():
...
def approval():
  ...
  try:
    httpCaht = get_response('https://github.com/Rimu-404/SAGOR')
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO SAGOR TOOL AND ENJOY \33[0;m")
      print('\33[1;37m ====================================================')

      print ("\33[1;37m SEND 100 TK (FOR 15 DAYS APPROVEL)")
      print('\33[1;37m ====================================================')
      print ("\33[1;37m SEND 300 TK (FOR 30 DAYS APPROVEL)")
      print('\33[1;37m ====================================================')
      print ("\33[1;37m BKASH/NOGOD (01328718707)")
      print ("\33[1;37m BKASH/NOGOD (01328718707)")
